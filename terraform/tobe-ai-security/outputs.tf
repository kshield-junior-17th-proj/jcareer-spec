...
output "edge" {
  ...
  value = {
    ...
    owner_stack_binding = module.edge.owner_stack_binding
  }
}
...
output "bedrock_boundary" {
  ...
  value = {
    ...
    gateway_broker_policy_name = module.bedrock_boundary.gateway_broker_policy_name
    gateway_deny_policy_name   = module.bedrock_boundary.gateway_deny_policy_name
    approval_input_sha256      = module.bedrock_boundary.approval_input_sha256
  }
}
...
output "metadata_observability" {
  ...
  value = {
    ...
    audit_bucket       = module.metadata_observability.audit_bucket_name
    evidence_table     = module.metadata_observability.evidence_table_name
    kms_alias          = module.metadata_observability.kms_alias_name
    cloudtrail_name    = module.metadata_observability.cloudtrail_name
    guardrail_alarm    = module.metadata_observability.guardrail_block_alarm_name
    publisher_policies = module.metadata_observability.publisher_policy_names
