...
[애니메이션 SVG](../../assets/JCAREER_FULL_INFRA_ANIMATED.svg)를 먼저 볼 수 있다. 서비스·보조
경로를 누르면 AWS 상세 강조 도면 또는 MLOps 7단계 전용 도면으로 실제 화면이 바뀐다.
...
3. CSV 1개와 검증 JSON 2개를 S3 입력 경로에 보관한다.
