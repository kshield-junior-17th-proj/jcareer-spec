...
require("src/runtime/VERIFICATION.md", "58개 셀·14개 연결", "public diagram count")
...
require("terraform/asis/JCAREER_ASIS_FLOW.md", "흐름선이 없으며 webhook/token", "Slack no-AWS-flow boundary")
