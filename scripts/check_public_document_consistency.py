...
require("src/runtime/VERIFICATION.md", "60개 셀·14개 연결", "public diagram count")
...
require("terraform/asis/build-spec.mjs", "<dt>기준일</dt><dd>2026-09-01</dd>", "spec date")
require("terraform/asis/JCAREER_ASIS_SYSTEM_SPEC.md", "SCENARIO_USE_UNVERIFIED", "Slack operational boundary")
require("terraform/asis/JCAREER_ASIS_FLOW.md", "기본 비활성 Slack webhook 어댑터", "Slack adapter source boundary")
require("terraform/asis/JCAREER_ASIS_FLOW.md", "실제 credential, Slack/Notion workspace, 메일 시스템, 메시지 전송", "outbound integration non-live boundary")
require("terraform/asis/JCAREER_ASIS_FLOW.md", "TRACE_MODE` 기본값은 `disabled", "TRACE default-off boundary")
